...
public class Player1Win {
  ...
  public void testPlayer1Win() throws Exception {
    ...
    for (int second = 0;; second++) {
    	...
    	try { if ("Player 1 WON!".equals(driver.findElement(By.id("status")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }

    try {
      assertEquals("Player 1 WON!", driver.findElement(By.id("status")).getText());
    } catch (Error e) {
